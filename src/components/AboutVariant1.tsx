            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-12">
                {[
                  ...
                  <div key={index} className="p-6 rounded-lg bg-gradient-to-br from-gray-900/20 to-purple-900/5 border border-purple-500/10 hover:border-purple-400/20 transition-all duration-500 group">
